    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Роли</h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center py-1">
                <a href="{{ route('role.create') }}" class="btn btn-sm btn-primary">Добавить</a>
            </div>
                        ...
                        <table class="table table-rounded table-striped border gy-7 gs-7">
                            ...
                            @foreach($roles as $k=>$role)
                                <tr>
                                    ...
                                    <td>{{ $role->name }}</td>
                                    <td>
                                        <a class="menu-link" href="{{ route('role.show', $role) }}">
                                            <i class="bi bi-eye fs-2x"></i>
                                        </a>
                                        <a class="menu-link" href="{{ route('role.edit', $role) }}">
