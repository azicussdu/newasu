...
return [
    ...
    'attributes'           => [
        ...
        'gender_id'               => 'Пол',
        'region_id'               => 'Районный центр, откуда прибыл',
        'family_status_id'               => 'Семейное положение',
        'citizenship_id'               => 'Гражданство',
        'hostel'               => 'Общежитие',
        'orphan'               => 'Сирота',
        'child_without'               => 'Ребенок, оставшийся без попечения родителей',
        'disabled_person'               => 'Инвалид',
        'studying_military'               => 'Обучается на военной кафедре',
        'admission_date'               => 'Дата поступления',
        'education_admission_id'               => 'Образование при поступлении',
        'degree_type_id'               => 'Уровень образования',
        'studyform_id'               => 'Форма обучения',
        'foreign_lan_school_id'               => 'Изученный иностранный язык в школе',
        'profession_id'               => 'Специальность/Группа образовательных программ',
        'specialization_id'               => 'Специализация/Образовательная программа',
        'center_studylanguage_id'               => 'Язык обучения',
        'course_id'               => 'Курс обучения',
        'group_id'               => 'Группа',
        'paymentform_id'               => 'Форма оплаты',
        'benefit_id'               => 'Обучается по квоте',
        'age'                   => 'Возраст',
        'available'             => 'Доступно',
        'city'                  => 'Город',
        'content'               => 'Контент',
