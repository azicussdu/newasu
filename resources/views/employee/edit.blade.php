                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ $employee->lastname }}" required>
                                        @error('lastname')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ $employee->firstname }}" required>
                                        @error('firstname')
                                        <div class="text-danger"><small>{{ $message }}</small></div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="old_lastname" value="{{ $employee->old_lastname }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status" id="inlineRadio1" value="active" {{$employee->status=='active' ? 'checked':''}} >
                                            <label class="form-check-label" for="inlineRadio1">Да</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status" id="inlineRadio2" value="inactive" {{$employee->status=='inactive' ? 'checked':''}}>
                                ...
                                <div id="iin_kaz">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('iin') is-invalid @enderror" name="iin" value="{{ $employee->iin }}" required id="kt_inputmask_iin">
                                            @error('iin')
                                            <div class="text-danger"><small>{{ $message }}</small></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="citizenship_id" id="сitizenship_id" required>
                                            ...
                                            @foreach($citizenships as $citizenship)
                                                <option value="{{ $citizenship->id }}" {{ $employee->citizenship_id==$citizenship->id ? 'selected':'' }}>{{$citizenship->name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="living_address" value="{{ $employee->living_address }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Общий стаж работы</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="experience_total" value="{{ $employee->experience_total }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Научно-педагогический стаж</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="experience_science" value="{{ $employee->experience_science }}">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-document" role="tabpanel" aria-labelledby="nav-document-tab">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="identity_document_id" id="identity_document_id">
                                            ...
                                            @foreach($identity_documents as $identity_document)
                                                <option value="{{ $identity_document->id }}" {{ $employee->identity_document_id==$identity_document->id ? 'selected':'' }}>{{$identity_document->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="doc_number" value="{{ $employee->doc_number }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Серия документа, удостоверяющего личность</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="doc_ser" value="{{ $employee->doc_ser }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label required">Дата выдачи документа, удостоверяющего личность</label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="doc_give_date" value="{{ $employee->doc_give_date }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label required">Срок действия документа, удостоверяющего личность</label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="doc_end_date" value="{{ $employee->doc_end_date }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="doc_organ_id">
                                            ...
                                            @foreach($sel_identity_documents as $sel_identity_document)
                                                <option value="{{ $sel_identity_document->id }}" {{ $employee->sel_identity_document==$sel_identity_document->id ? 'selected':'' }}>{{$sel_identity_document->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="home_phone" value="{{ $employee->home_phone }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Мобильный телефон</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="mobile_phone" value="{{ $employee->mobile_phone }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="kkson_section_id">
                                            ...
                                            @foreach($kkson_sections as $kkson_section)
                                                <option value="{{ $kkson_section->id }}" {{ $employee->kkson_section_id==$kkson_section->id ? 'selected':'' }}>{{$kkson_section->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="scientificdegree_id">
                                            ...
                                            @foreach($scientificdegrees as $scientificdegree)
                                                <option value="{{ $scientificdegree->id }}" {{ $employee->scientificdegree_id==$scientificdegree->id ? 'selected':'' }}>{{$scientificdegree->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="academicstatus_id">
                                            ...
                                            @foreach($academicstatuses as $academicstatus)
                                                <option value="{{ $academicstatus->id }}" {{ $employee->academicstatus_id==$academicstatus->id ? 'selected':'' }}>{{$academicstatus->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
